...
A largura pode ser usada com várias unidades, como px, em e mm. A cor pode ser atribuída pelo nome em inglês ou por um código hexadecimal, assim como fizemos com o *background*, e o estilo é representada por palavras-chave, vamos ver algumas delas:
...
topo (top), direita (right), inferior (bottom) e esquerda (left).

Ex. para alterar somente a borda superior
...
Colocando apenas um valor mudamos todos os cantos do elemento, mas seguindo aquela mesma ordem que vimos no *padding* e *margin* - topo (top), direita (right), inferior (bottom) e esquerda (left) - conseguimos alterar cada canto separadamente.
